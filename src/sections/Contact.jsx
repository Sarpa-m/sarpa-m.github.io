...
const links = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/mauricio-sarpa',
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: '+55 19 99880-6868',
    href: 'tel:+5519998806868',
    icon: (
    ...
    <section id="contato" className="section">
      <div className="container">
        ...
        <div className="contact-inner reveal" ref={innerRef}>
          <p>
            Tenho interesse em novos projetos, oportunidades e colaborações.
            Se quiser trocar uma ideia, é só chamar.
          </p>

          <a href="mailto:mausarpa02@gmail.com" className="contact-email">
            mausarpa02@gmail.com
          </a>
